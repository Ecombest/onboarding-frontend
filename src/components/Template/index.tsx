            ...
            <div className="container mx-auto flex justdify-between py-5 border-b">
                <div className="left flex gap-3">
                    <button onClick={showModal} className="flex bg-blue-500 text-white px-4 py-2 border rounded-md">
                        Add template <span className="px-1"><BiUserPlus size={22}></BiUserPlus></span>
                    </button>
                </div>
            </div>
            <Modal
            ...
            >
                <Box sx={style}>
                    <Typography id="modal-modal-title" variant="h6" component="h2">
                        ...
                        <div className="py-2">
                            <label>Name</label>
                            <input type="text" name='name' onChange={handleFormAd} className='bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5' placeholder='Option label'></input>
                        </div>
                        <div className='flex'>
                            <div>
                                <label>Width</label>
                                <input type='number' name='width' onChange={handleFormAd} className='bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-50 p-2.5' placeholder='Max length'></input>
                            </div>
                            <div className='px-4'>
                                <label>Height</label>
                                <input type='number' name='height' onChange={handleFormAd} className='bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-50 p-2.5' placeholder='Max length'></input>
                            </div>
                        </div>
                        <div className='py-3'>
                            <Button
