          ...
          <div>
            <div className="flex">
              <div>
                ...
                <input
                  ...
                  value={campaign?.name}
                  onChange={(e) => {
                    setCampaign({ ...campaign, name: e.target.value } as CampaignIntergace);
                  }}
                  style={{ width: "30vh" }}
              ...
              <div className="margin-left">
                ...
                <input
                  ...
                  onChange={(e) => {
                    setCampaign({ ...campaign, productId: e.target.value } as CampaignIntergace);
                  }}
                  style={{ width: "30vh" }}
                  className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block p-2.5"
                  type="text"
              ...
              <div className="margin-left">
                ...
                <input
                  value={campaign?.productLink}
                  name="productLink"
                  onChange={(e) => {
                    setCampaign({ ...campaign, productLink: e.target.value } as CampaignIntergace);
                  }}
                  style={{ width: "60vh" }}
            ...
            <div className="flex py-3">
              <div>
                ...
                <input
                  value={campaign?.selectorHtml}
                  name="selectorHtml"
                  onChange={(e) => {
                    setCampaign({ ...campaign, selectorHtml: e.target.value } as CampaignIntergace);
                  }}
                  style={{ width: "30vh" }}
                  className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-50 p-2.5"
                  type="text"
              ...
              <div className="margin-left">
                ...
                <select
                  value={campaign?.imageType}
                  name="imageType"
                  onChange={(e) => {
                    setCampaign({ ...campaign, imageType: e.target.value } as CampaignIntergace);
                  }}
                  style={{ width: "30vh" }}
                  className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-50 p-2.5"
                >
...
const TemplateModal = (props: { open: boolean; onClose: () => void; setSelectedTemplate: any }) => {
  const boxStyle = {
              ...
              >
                {listTemplate.map((template: any, index) => (
                  <div
                    ...
                    key={index}
                    className="flex justify-between items-center template-item"
                  >
                    <span
                      style={{
                        marginBottom: "0px",
...
const OptionSetModal = (props: { open: boolean; onClose: () => void; selectedOptionSet: any }) => {
  const boxStyle = {
    position: "absolute" as "absolute",
    top: "50%",
    left: "50%",
